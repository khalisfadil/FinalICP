    ...
    namespace traj {
        ...
        class JinvVelocityEvaluator : public Evaluable<Eigen::Matrix<double, 6, 1>> {
            public:
                ...
                //Constructor.
                JinvVelocityEvaluator(const Evaluable<XiInType>::ConstPtr& xi, const Evaluable<VelInType>::ConstPtr& velocity);
        ...
        // clang-format off
        JinvVelocityEvaluator::Ptr jinv_velocity(const Evaluable<JinvVelocityEvaluator::XiInType>::ConstPtr& xi,
